...
#define IDX_BMP_BTN_BASE_BIG				21		//	
#define IDX_BMP_BTN_BASE_MIDDLE				22		//	
#define IDX_BMP_BTN_BASE_LONG				23		//	
#define IDX_BMP_BTN_SMS			        	24		//	

#define IDX_BMP_MAX							25		//
...
#define IDX_ICON_CAMERA					    8		//
#define IDX_ICON_SMS					    9		//
#define IDX_ICON_BLACKLIST				    10		//
#define IDX_ICON_ADDUSER				    11		//

...
{
	if( nIconID >= IDX_ICON_MAX ||	nType > ICON32 )
		return NULL;
...
CString CGlobal::GetIconFileName(UINT nIconID)
{
	...
	case IDX_ICON_CAMERA						:	return _T("..\\skin\\camera.ico");					break;
	case IDX_ICON_SMS							:	return _T("..\\skin\\sms.ico");						break;
	case IDX_ICON_BLACKLIST						:	return _T("..\\skin\\blacklist.ico");				break;
	case IDX_ICON_ADDUSER						:	return _T("..\\skin\\adduser.ico");					break;
	}
	return _T("");
}
...
CString CGlobal::GetBitmapFileName(UINT nBitmapID)
{
	...
	case IDX_BMP_BTN_BASE_BIG				:	return _T("..\\skin\\btn_base_big.bmp");			break;
	case IDX_BMP_BTN_BASE_MIDDLE			:	return _T("..\\skin\\btn_base_middle.bmp");			break;
	case IDX_BMP_BTN_BASE_LONG		    	:	return _T("..\\skin\\btn_base_long.bmp");			break;
	case IDX_BMP_BTN_SMS		        	:	return _T("..\\skin\\btn_sms.bmp");		        	break;

...
class CSMSHistoryDlg : public CSkinDialog
{
	DECLARE_DYNAMIC(CSMSHistoryDlg)

public:
	CSMSHistoryDlg(CWnd* pParent = NULL);   // 표준 생성자입니다.
	virtual ~CSMSHistoryDlg();

// 대화 상자 데이터입니다.
	enum { IDD = IDD_SMSHISTORY_DIALOG };
